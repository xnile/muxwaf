    ...
    <a-card>
      ...
      >
        ...
        <template slot="operation" slot-scope="text, record">
          ...
          <a-button type="link" size="small" @click="onUpdate(record)">修改备注</a-button>
...
import { GetIPList, AddIP, UpdateIP, UpdateIPStatus, DeleteIP, IsIncluded, BatchAddIP } from '@/api/whitelist/ip'
...
export default {
  ...
  methods: {
    ...
    onBatchDel() {
      let _this = this
      this.$confirm({
        title: '确定要删除所选的' + _this.selectedRowKeys.length + '个IP白名单',
        onOk() {
